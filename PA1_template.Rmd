...
We can see from above that the total steps per day ranges from `r min(steps_per_day[,1])` to `r max(steps_per_day[,1])` with a median of `r median(steps_per_day[,1])` and a mean of   
`r round(mean(steps_per_day[,1]))`.
